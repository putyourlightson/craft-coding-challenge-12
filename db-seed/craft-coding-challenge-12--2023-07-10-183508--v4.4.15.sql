...
CREATE TABLE `content` (
  ...
  `dateUpdated` datetime NOT NULL,
  `uid` char(36) NOT NULL DEFAULT '0',
  `field_dates_hozrxife` text DEFAULT NULL,
  PRIMARY KEY (`id`),
...
) ENGINE=InnoDB AUTO_INCREMENT=948 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2023-07-10 18:35:08
-- MariaDB dump 10.19  Distrib 10.6.12-MariaDB, for Linux (aarch64)
--
-- Host: mysql    Database: project
-- ------------------------------------------------------
...
set autocommit=0;
INSERT INTO `info` VALUES (1,'4.4.15','4.4.0.4',0,'simgznfsvecy','3@jxsbnosthc','2023-02-02 05:28:23','2023-07-10 18:29:11','876de66d-7fde-40c5-b8b8-c4713c00d927');
...
set autocommit=0;
INSERT INTO `userpreferences` VALUES (1,'{\"language\":\"en\",\"locale\":null,\"weekStartDay\":\"1\",\"alwaysShowFocusRings\":false,\"useShapes\":false,\"underlineLinks\":false,\"notificationDuration\":\"5000\",\"showFieldHandles\":false,\"enableDebugToolbarForSite\":true,\"enableDebugToolbarForCp\":false,\"showExceptionView\":false,\"profileTemplates\":false}');
...
set autocommit=0;
INSERT INTO `users` VALUES (1,NULL,1,0,0,0,1,'admin','',NULL,NULL,'info@putyourlightson.com','$2y$13$crqJ.kzM.kBs.WsWGUxT9uUdR4Imi./d9prVKVya/MkWu/Bd/8.Ga','2023-07-10 18:21:55',NULL,NULL,NULL,'2023-07-07 12:51:18',NULL,1,NULL,NULL,NULL,0,'2023-02-02 05:28:24','2023-02-02 05:28:24','2023-07-10 18:22:40');
